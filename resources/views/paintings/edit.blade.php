        ...
        <div class="row card-style p-5 my-5">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="name_color" class="form-control hex-color-picker-input" placeholder="{{ $painting->name_color }}" value="{{ $painting->name_color }}" autocomplete="off" readonly style="background-color:{{ $painting->name_color }};">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Button Color:</strong>
                    <input type="text" name="button_color" class="form-control hex-color-picker-input" placeholder="{{ $painting->button_color }}" value="{{ $painting->button_color }}" autocomplete="off" readonly style="background-color:{{ $painting->button_color }};">
                </div>
            </div>
